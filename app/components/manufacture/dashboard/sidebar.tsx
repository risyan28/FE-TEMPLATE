...
function renderMenu(items: MenuItem[], level = 0) {
        ...
        {hasChildren ? (
          <button
            ...
            className={`flex w-full items-center gap-3 rounded-md px-3 py-2 text-left transition-colors ${
              isOpen
                ? 'bg-toyota-red-light font-semibold text-toyota-red-dark'
  ...
  return (
    <div
      className={`fixed inset-y-0 left-0 z-50 h-screen w-72 transform border-r bg-white shadow-lg transition-transform duration-300 ease-in-out ${
